...
## Algorithm
1. Load and preprocess the weather dataset by handling missing values and converting time data.
2. Perform feature engineering by extracting time-based features and creating lag variables.
3. Split the dataset into training and testing sets using time-based splitting.
4. Train a Random Forest model for each target variable (temperature, PM2.5, solar radiation).
5. Evaluate the model performance and predict future values using the latest available data.
...
df = pd.read_csv("C:/Users/acer/Downloads/weather-station-eee-block_2024_07_13 (1).csv")
...
```
## Output:
<img width="1308" height="599" alt="Screenshot 2026-03-23 160408" src="https://github.com/user-attachments/assets/f5773d7f-56e0-4222-8339-85b9c5f31e67" />
<img width="1279" height="454" alt="Screenshot 2026-03-23 160421" src="https://github.com/user-attachments/assets/c9b826fb-73c2-4b28-a983-12777323b732" />
<img width="1330" height="590" alt="Screenshot 2026-03-23 160433" src="https://github.com/user-attachments/assets/d2703886-56ec-407a-b29c-36532c430978" />




## Result:
The model accurately predicts temperature, air pollution, and solar radiation using past data and environmental features.
